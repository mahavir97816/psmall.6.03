...
$id = $_SESSION['id'];
$q_withdraw_records = "SELECT * from withdraw where wallet_id = $id ";
...
<b style="margin-left:20px;margin-bottom:10px;font-size:25px;color:white">Withdraw Records</b>
</div>
