...
$id = $_SESSION['id'];
$q_recharge_records = "SELECT * from recharge where wallet_id = $id order by order_number ";
...
<b style="margin-left:20px;margin-bottom:10px;font-size:25px;color:white">Recharge Record</b>
</div>
